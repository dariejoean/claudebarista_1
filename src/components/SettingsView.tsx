    ...
    return (
        <div className="animate-fade-in pb-20 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <button onClick={handleSync} className={BIG_BUTTON_STYLE}>
                    <CloudArrowUpIcon className={getIconStyle('text-green-400')} />
                    <span className={BUTTON_TEXT_STYLE}>SYNC GOOGLE DRIVE</span>
                </button>
